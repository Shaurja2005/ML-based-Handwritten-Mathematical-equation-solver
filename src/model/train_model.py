...
def train_svm_model(csv_path):
    ...
    # 5. Final Training on the full 80% split
    print(" Training final model on the full training set...")
    svm_model.fit(X_train_scaled, y_train)
    
    # 6. Final Evaluation on the unseen 20%
